      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Supercharge your workflows with Cuper.ai</h2>
            <p className="text-xl text-gray-400">Seamlessly integrate AI into your business operations for enhanced productivity and revenue.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Tailored Assistance</h4>
              <p className="text-lg text-gray-400 text-center">Our dedicated support accompanies you throughout your AI journey, empowering you to make informed and effective integration decisions.</p>
              </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Integrated Solutions</h4>
              <p className="text-lg text-gray-400 text-center">Seamlessly integrate Cuper.ai into your workflow with easy compatibility for popular platforms like Slack and Microsoft Teams.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Heightened Security</h4>
              <p className="text-lg text-gray-400 text-center">Keep your data secure with local LLM hosting options, hosted on your own servers if need with no chance of data leaks</p>
            </div>
